...
import com.dun.open_process_flow.model.ErrorError;
...
public class Error {
  ...
  private @Nullable ErrorError error;

  @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME)
  private @Nullable OffsetDateTime timestamp;

  public Error success(@Nullable Boolean success) {
  ...
  public Error error(@Nullable ErrorError error) {
    this.error = error;
    return this;
  }
  ...
  @JsonProperty("error")
  public @Nullable ErrorError getError() {
    return error;
  }

  public void setError(@Nullable ErrorError error) {
    this.error = error;
  }
