...
public class ErrorError {
  ...
  public ErrorError code(@Nullable String code) {
    this.code = code;
    return this;
  }
  ...
  public ErrorError message(@Nullable String message) {
  ...
  @Schema(name = "message", example = "Invalid input data", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  public ErrorError details(List<String> details) {
    this.details = details;
    return this;
  }

  public ErrorError addDetailsItem(String detailsItem) {
